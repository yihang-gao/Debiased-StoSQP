...
\textcolor{blue}{In this section, we developed a stochastic optimization algorithm with almost sure convergence guarantees for solving (\ref{original_problem0}).  To accomplish this,} 
